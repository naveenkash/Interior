...
export default function freeconsult() {
    return (
        <div className=" consult">
            <div className="animated fadeInUp discount-heading">
                <p><span>25%</span>DISCOUNT ON YOUR FIRST DESIGN</p>
            </div>
            <div className="animated fadeInUp craft">
                <h1 className="animated fadeInUp">We craft affordable design</h1>
            ...
            <div className="animated fadeInUp email-consult">
