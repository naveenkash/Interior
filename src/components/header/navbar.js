...
export default class Navebar extends React.Component {
    ...
    showUserForm = (e) => {
        e.preventDefault();
            this.setState({ IsUserClicked: true },()=>{this.props.userClicked(this.state.IsUserClicked)})
           

    }
    burger=(e)=>{
        e.preventDefault();
        this.setState({ IsBurgeClicked: true },()=>{  this.props.burgerClicked(this.state.IsBurgeClicked);})
      
    }
    showSearch=(e)=>{
        e.preventDefault();
            this.setState({ IsSearchClicked: true },()=>{  this.props.searchClicked(this.state.IsSearchClicked);})
                    ...
                    <div className="navbar-wrapper">
                        ...
                        <div className="navbar-items">
                            <div className="nav-item">
                                ...
                                <div onClick={this.burger} className="burger-wrapper">
